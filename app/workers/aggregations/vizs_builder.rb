    ...
    if aggregation.genre == "provider" or aggregation.genre == "data_provider"
      ...
      begin
        aggregation.core_datacasts.each do |core_datacast|
          ...
          validate = false
          core_viz = Core::Viz.find_or_create(core_datacast.identifier,core_datacast.name,ref_chart.combination_code,core_datacast.core_project_id,filter_present,filter_column_name,filter_column_d_or_m, validate)
        end

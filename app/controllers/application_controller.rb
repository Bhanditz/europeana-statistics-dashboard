class ApplicationController < ActionController::Base
  ...
  def set_universal_objects
    ...
    if @account.blank? 
      @account = current_account  if controller_name == "projects" and action_name == "new" or action_name == "referrals" or controller_name == "referral_gifts" or controller_name == "account_emails"
    end
  end
